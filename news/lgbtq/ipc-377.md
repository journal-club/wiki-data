...
The definition for the hijra community that I included in the editorial is merely an attempt to simplify it for the sake of easier digestion, but the reality is that it’s not that simple. It is not a homogenous monolithic unitarian identity that can or should be force fitted into a definition, and doing so would be utterly disrespectful to the said community.
